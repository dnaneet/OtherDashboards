...
if selection == "Summary of changes":
    ...
    st.markdown("I modified MEP3 to have a greater focus on collaboratively-created/team-created works products.  Individual assignments have formative assessment with multiple possible attempts while team assignments have used summative assessment (Bain, 2020). Students have engaged with course content and tested their software skills via individual assignments.  Team assignments relied on individually developed skills.  This approach ensured that the focus was on 'teamwork.' The formative-assessment nature of individual assignments allowed me (instructor) to engage students in constructive dialogue rather than arguments ('where/why did I 'lose' points?'').")  

    st.write("(Bain, Ken. Super Courses: The Future of Teaching and Learning. Princeton University Press, 2021.)")

    st.markdown("###  Design Reviews delivered as media files") 
    ...
    st.markdown("### Student design-teams of 5-6 members")
    ...
    st.markdown("### Critical Incident Questionnaire (CIQ) to collect weekly data on team dynamics")
...
if selection == "Critical Incident Questionnaire data":
  ...
  st.markdown("Unlike the 'early-term survey' deployed through Canvas, the CIQ represents a weekly evolution of team dynamics, instead of a single data point collected in week-4.  I used my prior experience with MEP3 and the CIQ data collected on a weekly basis to recognize challenges and provided positive intervention to teams when needed.  This may not have perfectly solved 'team problems' (some of which are not communicated by teams) but allowed me to preemptively allay them.  I speculate that high-functioning teams are the ones that voluntarily completed this survey.  If this were made mandatory, it would develop really good picture of team dynamics within a classroom ")
